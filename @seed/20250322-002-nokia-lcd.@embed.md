...
## Rust try 1 & 2: fail {#rust-try-1-2-fail}
...
## micropython-pcd8544: success! {#micropython-success}
...
### Step 2: MicroPython on SparkFun RP2040 {#micropython-on-rp2040}
...
### Step 3: test connection with PuTTy {#testing-conn-with-putty}
...
### Step 4: Download and install Thonny {#download-and-install-thonny}
