...
![A breadboard image with a programmer and board pins connected.](https://github.com/user-attachments/assets/35da6796-077f-4706-be58-68829cb0712f) {.showcase}



## ST-Link USB driver {#stlink-usb-driver}
...
## First try running probe-rs {#first-try-running-probe-rs}
...
## Second try via openocd {#second-try-via-openocd}
